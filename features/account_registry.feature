Feature: Account registry
    ...
    Scenario: User is able to update name of already created account
        ...
        When I update "name" of account with pesel: "88010112345" to "jane"
        Then Account with pesel "88010112345" has "name" equal to "jane"

    Scenario: Created account has all fields correctly set
        Given Account registry is empty
        When I create an account using name: "test", last name: "user", pesel: "90050512345"
        Then Account with pesel "90050512345" has "name" equal to "test"
        And Account with pesel "90050512345" has "surname" equal to "user"
        And Account with pesel "90050512345" has "pesel" equal to "90050512345"
